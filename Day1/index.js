...
newieyork.sort((a,b)=> a.age-b.age)
  ...
  console.log(newieyork);
      ...
      // Part 3 -  List all female coders
      const fe_coders = newieyork.filter(gndr=>gndr.gender=="f" && gndr.coder==true)
...
const total_age= vegzas.filter(num=>num.age<25 && num.gender=="m" && num.coder==true).map(age=>age.age).reduce((num1,num2)=>num1+num2)
console.log('total age->',total_age);



  // Part 2 - List all male coders over 30
  const list=vegzas.filter(ag=>ag.age>30&& ag.coder==true)
  console.log(list)
